...
namespace Transparent_Form
{
    class CourseClass
    {
        ...
        public bool updateCourse(int id, string cName, int hr, string desc)
        {
            ...
            {
                MessageBox.Show(ex.Message, "Enter a valid course", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }
        }
